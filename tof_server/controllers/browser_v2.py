...
controller_browser = Blueprint('controller_browser_v2', __name__, template_folder='templates')


@controller_browser.route('/v2/listing', methods=['GET'])
def first_page():
...
@controller_browser.route('/v2/listing/<int:offset_id>', methods=['GET'])
...
@controller_browser.route('/v2/author/<string:map_code>', methods=['GET'])
...
@controller_browser.route('/v2/top/downloads', methods=['GET'])
